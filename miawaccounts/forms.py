...
class ProfileUpdateForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'first_name': forms.TextInput(attrs={'placeholder': 'Masukkan Nama Depan'}),
            'last_name': forms.TextInput(attrs={'placeholder': 'Masukkan Nama Belakang'}),
            'email': forms.TextInput(attrs={'placeholder': 'Masukkan Email'}),
            'phone_number': forms.TextInput(attrs={'placeholder': '+62813xxx'}),
        }
